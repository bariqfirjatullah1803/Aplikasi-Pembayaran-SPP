<a href="<?= base_url('petugas/pembayaran')?>">Kembali</a>
<div class="card">
    <div class="card-body">
        <p>NIS : <?= $siswa['nis'] ?></p>
        <p>Nama : <?= $siswa['nama'] ?></p>
            ...
            foreach ($bulan as $b):?>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="<?= base_url('petugas/deleteTransaksi/').$pembayaran['id_transaksi'].'/'.$siswa['nis']?>" class="btn btn-primary">
                    ...
                    <td>Belum Lunas</td>
                    <td class="text-center">
                        <a href="<?= base_url('petugas/bayar/').$b['id_bulan'].'/'.$id_siswa.'/'.$user['id_user'].'/'.$spp['id_spp'].'/'.$siswa['nis']?>" class="btn btn-primary">
