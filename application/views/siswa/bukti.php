                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row invoice-spp">
                            ...
                            <div class="col-8">
                                <p>192</p>
                                <p>Achmada awdi dzulfilqar zaidan ghalib</p>
                                <p>XII RPL 5</p>
                            </div>
                        </div>
                    </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>SPP</td>
                            <td>Pembayaran SPP Bulan Mei</td>
                            <td>Rp. 250.000</td>
                        </tr>
                        <tr>
                            <td>#558133</td>
                            <td>SPP</td>
                            <td>Pembayaran SPP Bulan Maret</td>
                            <td>Rp. 250.000</td>
                        </tr>
